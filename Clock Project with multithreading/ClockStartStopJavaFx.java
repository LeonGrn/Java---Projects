import javafx.application.Application;//Leon Grinshpun 316226679
...
public class ClockStartStopJavaFx extends Application 
{
	...
	public void start(Stage primaryStage) throws Exception 
	{
		...
		AnnounceTimeOnSeparateThread announceVoice = new AnnounceTimeOnSeparateThread(clock);
		Thread announceVoiceThread = new Thread(announceVoice, "Thread voice");
		Thread clockMoveThread = new Thread(tick, "Thread clock");
		announceVoiceThread.start();
